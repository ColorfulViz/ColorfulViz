...
@Component({
  selector: 'app-barsimple',
  templateUrl: './barsimple.component.html',
  styleUrls: ['./barsimple.component.css']
})
export class BarsimpleComponent implements OnInit {
  ...
  setColor(e: any) {
    ...
    if (a != undefined)
      index = parseInt(a);
    BarsimpleComponent.chart_color = this.default_colors[index - 1];
    BarsimpleComponent.bar_color = this.default_colors[Math.round(Math.random()*9)];
    console.log(BarsimpleComponent.chart_color);
    console.log(BarsimpleComponent.bar_color);
    alert("颜色选择成功！")
  }
  ...
  public static getColors(color: any[]) {
    ...
    BarsimpleComponent.colors = color;
    console.log(BarsimpleComponent.colors);
    BarsimpleComponent.chart_color = BarsimpleComponent.colors[0].name;
    BarsimpleComponent.bar_color = BarsimpleComponent.colors[3].name;
  }
  ...
  change_Pic(e: any) {
    ...
    reads.onload = function () {
      ...
      index.handle(f, BarsimpleComponent.getColors);
    }
  }
  ...
  draw_Chart() {
    ...
    var option = {
      ...
      title: {
          ...
          textStyle:{
              color: BarsimpleComponent.chart_color
          }
      },
      tooltip: {},
      ...
      series: [{
          ...
          // seriesLayoutBy: 'row',
          type: 'bar',
          color: BarsimpleComponent.bar_color                
      }]
  };
